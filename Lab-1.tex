...
\begin{enumerate}[label=(\arabic*)]
  ...
  \item{
    Understand how to \textbf{create} a Simulink diagram and how to run
    a simulation.
  }
  \item{
...
questions where it is shown per question. Your grade in each row is determined
as per the letter grading scheme described by Table~\ref{tab:letter-grading}.
%
\begin{table}
\centering
...
Lab Subtotal&                       & 30      \\ \hhline{=|=|=|=}
        ...
        & \ref{lab1:report}~\ref{lab1:report:q8}  & 1       \\ \hline
        & \ref{lab1:report}~\ref{lab1:report:q9}  & 1       \\ \hline
        & \ref{lab1:report}~\ref{lab1:report:q10} & 4       \\ \hline
        & \ref{lab1:report}~\ref{lab1:report:q11} & 4       \\ \hline
