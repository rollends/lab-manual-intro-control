...
\begin{center}
  \begin{tikzpicture}[x=1in, y=1in]
    ...
    \node [draw, smooth_block] (Plant) {%
      \(\frac{1}{s\left(\frac{s^3}{N} + s^2 + \left(K_d + \frac{K_p}{N}\right) s + K_p\right)}\)%
    };
      ...
      \begin{center}
        \begin{tikzpicture}[x=1in, y=1in]
          ...
          \node [draw, smooth_block, left = 0.50 of Sum2] (Gain1) {
            \(
              \frac{
                \left(K_d + \frac{K_p}{N}\right) s^2 + \left(K_p + \frac{K_i}{N}\right) s + K_i
              }{
                s\left(\frac{s}{N} + 1\right)
              }
            \)
