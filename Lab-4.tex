...
The controller you design controls the turning rate \SI{}{rad/s} and the output you measure is the distance to the straight line path \(y(t).\)
...
\[
  P(s) = \frac{1}{s^2}.
\]
Take \texttt{ECE 486} if you are interested in how to do this.
%
\begin{figure}
  \centering
