...
\begin{deliverable}[label={lab3:report}]
  \begin{enumerate}[label={(\arabic*)}]
    \item{%
      ...
      the transfer function from \(r(t)\) to \(x(t)\) of the entire closed loop system equals
      \[
        G_3(s) = \frac{K_4\sqrt{50}}{s^2 + \sqrt{50} s + K_4 \sqrt{50}}.
      \]
    ...
    \item{%
      The entire closed loop system can be described by the diagram in Figure~\ref{fig:lab3:entire}.
    ...
    \item{%
      ...
      Leveraging the estimate of the \(2\%\) settling time
      \[
        T_{2\%} \approx \frac{4}{\zeta \omega}
      \]
      and your transfer function in standard form (found in~\ref{lab3:report:q3}) \textbf{identify} the two gains that affect the settling time.
...
\begin{tabular}{c|l|c}
        ...
        & \ref{del:lab3:g3:1}         & 8      \\ \hline
        & \ref{del:lab3:g3:2}         & 4       \\ \hhline{=|=|=}
