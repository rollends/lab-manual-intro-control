...
\end{center}
%
Suppose we close the loop.
As in Lab~\ref{Lab:1}, you should observe that the new time constant \(\tau_2\) of the transfer function from \(v_r(t)\) to \(v(t),\) denoted by \(G_2(s),\) is given by
\[
