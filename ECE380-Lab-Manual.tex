...
\definecolor{Lime}{cmyk}{25, 0, 100, 0}
\definecolor{LiteLime}{cmyk}{0.05, 0, 0.2, 0}
...
\hypersetup{
  xetex,
  pdfauthor={Rollen S. D'Souza, Carmen Caradima},
  pdftitle={ECE/SE 380 --- Lab Manual},
...
{
  \rmfamily\HUGE\noindent
  \textbf{ECE/SE 380 --- Analog Control Systems}\\
  Fall 2021\\
  {Lab Manual v1.5}\\
}
\end{flushright}
